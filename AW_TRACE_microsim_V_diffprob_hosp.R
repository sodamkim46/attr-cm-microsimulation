...
l_trans_probs_st <- list(                # pack the transition probabilities and rates in a list
  "p_1to1" = p_1to1, "p_1to2" = p_1to2, "p_1to3" = p_1to3, "p_1to4" = p_1to4,
  "p_2to1" = p_2to1, "p_2to2" = p_2to2, "p_2to3" = p_2to3, "p_2to4" = p_2to4,
  "p_3to1" = p_3to1, "p_3to2" = p_3to2, "p_3to3" = p_3to3, "p_3to4" = p_3to4,
  "p_4to1" = p_4to1, "p_4to2" = p_4to2, "p_4to3" = p_4to3, "p_4to4" = p_4to4,
  "p_HtoD" = p_HtoD,
  "rr_HF"  = rr_HF,
  "rr_2v1" = rr_2v1,
  "rr_3v1" = rr_3v1,
...
l_trans_probs_si <- list(                # pack the transition probabilities and rates in a list
  "p_1to1" = p_1to1, "p_1to2" = p_1to2, "p_1to3" = p_1to3, "p_1to4" = p_1to4,
  "p_2to1" = p_2to1, "p_2to2" = p_2to2, "p_2to3" = p_2to3, "p_2to4" = p_2to4,
  "p_3to1" = p_3to1, "p_3to2" = p_3to2, "p_3to3" = p_3to3, "p_3to4" = p_3to4,
  "p_4to1" = p_4to1, "p_4to2" = p_4to2, "p_4to3" = p_4to3, "p_4to4" = p_4to4,
...
res_st <- run_microSimV_hosp(
  ...
  v_util_coeffs       = v_util_coeffs,
  v_util_t_decs       = v_util_t_decs,
  l_trans_probs       = l_trans_probs_st,
...
res_si <- run_microSimV_hosp(
  ...
  v_util_coeffs       = v_util_coeffs,
  v_util_t_decs       = v_util_t_decs,
  l_trans_probs       = l_trans_probs_si,
